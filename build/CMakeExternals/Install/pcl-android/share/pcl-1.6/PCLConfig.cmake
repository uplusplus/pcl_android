...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "/work/project/pcl-android/build/CMakeExternals/Install/boost-android/include")
  ...
  #find_package(Boost 1.40.0 ${QUIET_} COMPONENTS system filesystem thread date_time chrono iostreams)
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "/work/project/pcl-android/build/CMakeExternals/Install/eigen" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
macro(find_openni)
  if(NOT OPENNI_ROOT AND ("OFF" STREQUAL "ON"))
    set(OPENNI_INCLUDE_DIRS_HINT "")
    set(OPENNI_LIBRARY_HINT "")
  endif(NOT OPENNI_ROOT AND ("OFF" STREQUAL "ON"))
  ...
  find_path(OPENNI_INCLUDE_DIRS XnStatus.h
    ...
    PATHS "$ENV{PROGRAMFILES}/OpenNI/Include" "$ENV{PROGRAMW6432}/OpenNI/Include" "${OPENNI_INCLUDE_DIRS_HINT}"
  ...
  find_library(OPENNI_LIBRARY 
    ...
    HINTS ${PC_OPENNI_LIBDIR} ${PC_OPENNI_LIBRARY_DIRS} 
          "${OPENNI_ROOT}" "$ENV{OPENNI_ROOT}"
    PATHS "$ENV{PROGRAMFILES}/OpenNI/Lib" "$ENV{PROGRAMW6432}/OpenNI/Lib64" "${OPENNI_LIBRARY_HINT}"
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/work/project/pcl-android/build/CMakeExternals/Install/flann-android/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
macro(find_VTK)
  ...
  if (VTK_FOUND AND VTK_MAJOR_VERSION LESS 6)
    set(VTK_LIBRARIES vtkCommon vtkRendering vtkHybrid)
  endif(VTK_FOUND AND VTK_MAJOR_VERSION LESS 6)
endmacro(find_VTK)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/work/project/pcl-android/build/CMakeExternals/Source/pcl")
...
set(pcl_all_components  common octree io kdtree search features geometry ml sample_consensus filters registration recognition segmentation surface keypoints tracking )
...
set(pcl_header_only_components 2d geometry cuda_common gpu_tracking)
